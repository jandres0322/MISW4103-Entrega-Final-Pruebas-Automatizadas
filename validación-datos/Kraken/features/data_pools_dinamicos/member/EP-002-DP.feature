...
@EP002 @user1 @web
Scenario: No debe agregar miembro con correo vacío
  ...
  When I fetch data from Mockaroo API "https://my.api.mockaroo.com/ghost_member.json?key=e7ea47e0" not email
